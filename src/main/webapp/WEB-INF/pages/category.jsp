                                ...
                                <ul class="list-group">
                                    <li class="list-group-item">
                                        <ul class="list-group">
                                            ...
                                            <li class=" list-group-item accordion accordion-flush"
                                                ...
                                                <div class="accordion-item">
                                                    ...
                                                    <div class="accordion-collapse collapse show"
                                                        ...
                                                        <c:forEach var="work" items="${category.works}">
                                            ...
                                            <li class=" list-group-item">
                                                <a class="btn btn-outline-primary" <ext:href path="/order/create?category=${category.keyName}&currency=${currency.code}"/> role="button">

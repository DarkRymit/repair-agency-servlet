...
public class ReceiptDeliveryUpdateRequest {
    ...
    public ReceiptDeliveryUpdateRequest(String country, String state, String city, String localAddress,
            String postalCode) {
    ...
    public ReceiptDeliveryUpdateRequest() {
    }
    ...
    public boolean equals(Object o) {
        ...
        ReceiptDeliveryUpdateRequest that = (ReceiptDeliveryUpdateRequest) o;
    ...
    public String toString() {
        return "ReceiptDeliveryUpdateRequest{" +
                "country='" + country + '\'' +
                ", state='" + state + '\'' +
                ", city='" + city + '\'' +
